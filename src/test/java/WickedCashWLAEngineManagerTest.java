...
public class WickedCashWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(WickedCashWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/WickedCashWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/WickedCashWLAIW/InitOutcome.xml").getDocumentElement();
